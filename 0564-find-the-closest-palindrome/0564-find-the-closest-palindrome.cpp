...
public:
    ...
    string nearestPalindromic(string n) 
    {
        ...
        vector<long> res;
        res.push_back(halfToPalindrome(firstHalf, len % 2 == 0));
        res.push_back(halfToPalindrome(firstHalf + 1, len % 2 == 0));
        res.push_back(halfToPalindrome(firstHalf - 1, len % 2 == 0));
        res.push_back((long)pow(10, len - 1) - 1);
        res.push_back((long)pow(10, len) + 1);
        long diff= LONG_MAX;
        long result=0;
